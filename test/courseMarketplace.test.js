...
contract("CourseMarketplace", accounts => {
    ...
    describe("Purchase the new course", () => {
        ...
        it("scan get the purchased course hash by index", async () => {
            const index = 0;
            ...
            assert.equal(courseHash, expectedHash, "Course hash is not matching the hash od purchased course");
        });
    ...
    describe("Transfer ownership", () => {
        ...
        it("should transfer ownership back to initial Contract owner'", async () => {
            ...
            const owner = await _contract.getContractOwner()
            assert.equal(owner, contractOwner,"Contract owner is not the set!");
        });
    })
})