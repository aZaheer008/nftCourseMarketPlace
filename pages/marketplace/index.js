                      ...
                      Footer={() => {
                        ...
                        if (owned) {
                          return (
                            <>
                            <div>
                              <Button onClick={() => alert("You are owner of this course.")} size="sm" disabled={false} variant="white">
                                Yours &#10004;
                              </Button>
                              {
                        ...
                        return (
                            <Button size="sm" onClick={() => setSelectedCourse(course)} disabled={!hasConnectedWallet} variant="lightPurple">
                              Purchase
                            </Button>
                        )}
                      }
