    ...
    return (
        <div className="flex mr-2 relative rounded-md">
            <input 
                ...
                name="account"
                id="account"
                className="w-96 focus:ring-indigo-500 shadow-md focus:border-indigo-500 block pl-7 p-4 sm:text-sm border-gray-300 rouded-md "
...
export default function ManagedCourses() {
    ...
    const [ proofedOwnership , setProofOwnership ] = useState({})
